...
<form class="form-horizontal" role="form" method="post" action="${pageContext.request.contextPath}/vehicle/edit/${vehicleId}">
  <div class="form-group">
    <label for="vehicleNumber" class="col-sm-3 control-label">Vehicle Number</label>

    <div class="col-sm-6">
      <input type="text" class="form-control" id="vehicleNumber" name="vehicleNumber" placeholder="" value="${vehicleNumber}">
    </div>
  </div>
  <div class="form-group">
